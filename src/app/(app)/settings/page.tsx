      ...
      <div className="space-y-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>IMAP で受信トレイ・送信済みを取り込み、SMTP で送信します。取り込みは自動では行わず、「メール同期」ボタンを押したときだけ実行します。</CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="text-sm space-y-4">
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>画面右上または受信トレイの「メール同期」ボタンを押すと、新着メールを取り込みます。自動取得は行いません。</li>
            </ol>
